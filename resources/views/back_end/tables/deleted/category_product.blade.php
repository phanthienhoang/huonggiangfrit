                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach($deletedCategories ?? '' as $categoryProduct)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-block">
                                            <a href="{{ route('admin.category-products.restore', $categoryProduct->id) }}"
                                                class="btn btn-warning"><i class="fa fa-retweet"></i> Restore</a>
                                            <form class="d-inline"
                                                action="{{route('admin.category-products.forceDelete',$categoryProduct->id)}}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
