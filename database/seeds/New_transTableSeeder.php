...
class New_transTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $new_tran->new_id = 1;
        $new_tran->locale = 'vi';
        $new_tran->slug = 'thong-bao-DHDCD-thuong-nien-nam-2017';
        $new_tran->save();
        ...
        $new_tran->new_id = 1;
        $new_tran->locale = 'en';
        $new_tran->slug ='Notice-of-Annual-General-Meeting-of-Shareholders-2017';
        $new_tran->save();
        ...
        $new_tran->new_id = 2;
        $new_tran->locale = 'vi';
        $new_tran->slug = 'tinh-hinh-kinh-te-va-san-xuat-gom-su-cac-nuoc-thanh-vien-CICA';
        $new_tran->save();
        ...
        $new_tran->new_id = 2;
        $new_tran->locale = 'en';
        $new_tran->slug ='Economic-situation-and-ceramics-production-of-CICA-member-countries';
            $new_tran->save();
        ...
        $new_tran->new_id = 3;
        $new_tran->locale = 'en';
        $new_tran->slug ='Disclosure-of-information-on-change-of-business-registration-certificate';
        $new_tran->save();
    }
}
